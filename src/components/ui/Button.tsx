  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-arena-accent focus:ring-offset-2 focus:ring-offset-arena-bg disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-arena-card text-white hover:bg-arena-card/80 border border-arena-border",
        outline:
          "border border-arena-border bg-transparent text-white hover:bg-arena-border/50",
        ghost: "bg-transparent text-white hover:bg-arena-border/50",
        destructive:
          "bg-arena-con text-white hover:bg-arena-con/90 shadow-lg shadow-arena-con/25",
        success:
          "bg-arena-pro text-white hover:bg-arena-pro/90 shadow-lg shadow-arena-pro/25",
