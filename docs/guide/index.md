...
- [Web App Guide](/guide/web-app) - Using the web interface
- [Docker Guide](/guide/docker) - Running bots with Docker
- [CLI Guide](/guide/cli) - Full CLI reference
- [WebSocket Protocol](/guide/protocol) - Bot integration details
